    ...
    try {
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Twitter Setup', 'https://cdn.discordapp.com/emojis/840255600851812393.png?size=96', 'https://discord.gg/rngwYu3wYU')
...
/**
 * @INFO
 * Bot Coded by Limsathya | https://github?.com/LimsathyacordDev/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
 * Work for Limsathyacord | https:cord
 * @INFO
