...
<:LimsathyacordDevelopment:900389724936609842>  Made by [**Limsathyacord**](https://discord.gg/rngwYu3wYU)`)
.addField("How to get help?", `>>> **\` 1. Way \`** *Use the Buttons, to swap the Pages*\n**\` 2. Way \`** *Use the Menu to select all Help Pages, you want to display*\n**\` 3. Way \`** *Watch the Youtube Tutorial*`)
        ...
        function allotherembeds_eachcategory(filterdisabled = false){
          ...
          var embed7 = new MessageEmbed()
            ...
            .addField("<:LimsathyacordDevelopment:900389724936609842> **Most used Systems**", "> "+client.commands.filter((cmd) => cmd.category === "💪 Setup" && cmd.type.includes("system")).sort((a,b) => a.name.localeCompare(b?.name)).map((cmd) => `\`${cmd.name}\``).join("︲"))
