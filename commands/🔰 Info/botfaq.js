...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let Limsathyacorddc = client.guilds.cache.get("861490922873028608")
      let Limsathyacordmembers = await Limsathyacorddc.members.fetch().catch(() => {});
      let partnercount = Limsathyacordmembers.filter(m => m.roles.cache.has("861490922970021936"))
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/rngwYu3wYU")
