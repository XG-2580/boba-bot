    ...
    if (message.author.id != "594195050242768899")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only Limsathya is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.gg/rngwYu3wYU), open a Ticket and ask for it!`)
        ]
      });
    try {
